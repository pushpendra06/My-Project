...
<section>
   ...
   <div class="res-slider">
            <div class="" style=" width: 962px; height: 400px;" id="slider2_container">
...
<section class="planning-event-area">
    <div class="container">
    <div class="section-title text-center wow fadeInDown" data-wow-delay="0.3s" style="visibility: visible; -webkit-animation-delay: 0.3s; -moz-animation-delay: 0.3s; animation-delay: 0.3s;">
            <h1>About Us</h1>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="img-holder wow fadeInLeft" data-wow-delay="0.3s" style="visibility: visible; -webkit-animation-delay: 0.3s; -moz-animation-delay: 0.3s; animation-delay: 0.3s;">  
        	...
        	<div class="col-md-6 col-sm-12 col-xs-12">
                <div class="text wow fadeInRight" data-wow-delay="0.3s" style="visibility: visible; -webkit-animation-delay: 0.3s; -moz-animation-delay: 0.3s; animation-delay: 0.3s;">
    ...
    <div class="container">
        ...
        <div class="row">
            <!--Start single upcoming event item-->
             ...
             ?>
            <div class="col-md-4 col-sm-4 col-xs-12  wow bounceIn" data-wow-delay="0.3s" style="visibility: visible; -webkit-animation-delay: 0.3s; -moz-animation-delay: 0.3s; animation-delay: 0.3s;">
                <div class="single-upcoming-event-item">
                    ...
                    <div class="content">
                       ...
                       <?php echo substr($row3['msg'], 0, 200);  ?>............... <a href="events.php"> View More </a>
                        <ul>
...
<section class="planning-event-area" style="background-color: #fff">
    ...
    <div class="section-title text-center  wow fadeInDown" data-wow-delay="0.3s" style="visibility: visible; -webkit-animation-delay: 0.3s; -moz-animation-delay: 0.3s; animation-delay: 0.3s;">
        ...
        <div class="row">
         <div class="col-md-12  wow bounceIn" data-wow-delay="0.3s" style="visibility: visible; -webkit-animation-delay: 0.3s; -moz-animation-delay: 0.3s; animation-delay: 0.3s;">
