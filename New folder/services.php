...
$t = "SELECT * from services_details ";
...
$sql1 = "SELECT * from services_details LIMIT $start, $limit";
              ...
              <div class="row" style="margin-right: 0px; margin-left: 0px;">
                ...
                <!--               <td class="p-name" style="text-align:center;">< ?php echo $row['date1']; ?></td>
                          ...
                          <!--     <td class="p-name" style="text-align:center;">< ?php echo $row['place']; ?></td> -->
                              ...
                              <td class="p-name" style="text-align:center;"><img src="img/events/<?php echo $row['service_img']; ?>" width="70px" height="70px"></td>
                              <td class="p-progress" style="text-align:center;">  
                              <?php
                              if(($status)=='0')
                              {
                              ?>
                              <a href="eventsactive.php?rid=<?php echo $row['service_id']; ?>" class="btn btn-sm btn-success" onclick="return confirm('Activate')"><i class=" fa fa-eye"></i></a>
                              <?php
                              }
                              if(($status)=='1')
                              {
                              ?>
                              <a href="eventsactive.php?rid=<?php echo $row['service_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('De-activate')"><i class="fa fa-eye" aria-hidden="true"></i></a>
                              <?php
                              }
                              ?>
                              </td>
                              ...
                              <td class="p-progress" style="text-align:center;">  
                              <a href="eventsrep.php?rep=<?php echo $row['service_id']; ?>"><button type="button" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></button></a>
                              </td>
                              <td class="p-progress" style="text-align:center;"> 
                              <a href="eventsdel.php?del=<?php echo $row['service_id']; ?>"><button type="button" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure Delete this client')"><i class="fa fa-trash-o "></i></button></a></td>
                              </td>
...
<?php if($id>1) { ?>
<a href="services.php?id=<?php echo ($id-1) ; ?>" class="btn btn-sm btn-success" >Privious</a>
<?php }

for ($i=1; $i<=$page; $i++)
{ ?>
<a href="services.php?id=<?php echo $i; ?>" class="btn btn-sm btn-success" ><?php echo $i; ?></a>

<?php } ?>
<?php if($id!=$page) { ?>
<a href="services.php?id=<?php echo ($id+1); ?>" class="btn btn-sm btn-success" >Next</a>
<?php } ?>
</div>
</div>  
      </div><br><br> <br><br> 
...
function getStates(value){
  $.post("servicessearch.php",{partialState:value}, function(data){
    $("#demo").html(data);
  });
