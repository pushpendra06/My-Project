...
<!-- Mirrored from wp1.themexlab.com/html/smart-up/single-event.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Sep 2017 13:04:10 GMT -->
<head>
	<meta charset="UTF-8">
	<title>Event Details || Martup || Responsive HTML 5 Martup Template</title>
...
<section class="single-event-area">
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                <div class="single-event-img">
                    <img src="img/event/single-event/single-event.jpg" alt="Awesome Image">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                <div class="single-event-details">
                    <h3>Event Details</h3>
                    <ul>
                        <li><i aria-hidden="true" class="fa fa-calendar"></i>27th Jan, 2016</li>
                        <li><i class="fa fa-map-marker" aria-hidden="true"></i>118 St. Wendel Ave. , 64411 NYC</li>
                        <li><i aria-hidden="true" class="fa fa-bookmark-o"></i>business event</li>
                        <li class="guests"><i class="fa fa-user" aria-hidden="true"></i>
                            <p>guests</p>    
                            <div class="guests-right">
                                <p>Mark Parker, Johna Hill,<br>Jonson Daning</p>    
                            </div>
                        </li>
                        <li><i class="fa fa-tags" aria-hidden="true"></i><span>$39</span>/ per person</li>
                    </ul>
                    <div class="speaker">
                        <h5>Speaker:</h5>
                        <div class="img-holder">
                            <img src="img/event/single-event/speaker.png" alt="">    
                        </div>
                        <div class="text">
                            <p>Mark Terence</p>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                <div class="single-event-bottom-text">
                    <h1>Mark Terence Comedy Show</h1>
                    <span>starring Mark Terence and friends</span>
                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p>
                    
                    <ul>
                        <li>1241<p>Participants</p></li>
                        <li>14<p>Speakers</p></li>
                        <li>3h<p>Duration</p></li>
                        <li>457<p>Free Seats</p></li>
                        <li>18<p>Days to go</p></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="upcoming-event-area related-event-area">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="single-upcoming-event-item">
                    <div class="img-holder">
                        <img src="img/event/related-event/2.jpg" alt="Awesome Image">
                    </div>
                    <div class="content">
                        <h5>Nam liber tempor cum soluta nobis eleifend weste mondar</h5>
                        <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan.</p>
                        <ul>
                            <li><i class="fa fa-calendar" aria-hidden="true"></i>14th Jan, 2016</li>
                            <li><i class="fa fa-bookmark" aria-hidden="true"></i>outdoor party</li>
                        </ul>
                    </div>
                    <div class="readmore">
                        <a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>   
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="single-upcoming-event-item">
                    <div class="img-holder">
                        <img src="img/event/related-event/3.jpg" alt="Awesome Image">
                    </div>
                    <div class="content">
                        <h5>uis autem vel eum iriure dolor in hendrerit in vulputate molestie</h5>
                        <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan.</p>
                        <ul>
                            <li><i class="fa fa-calendar" aria-hidden="true"></i>11th Jan, 2016</li>
                            <li><i class="fa fa-bookmark" aria-hidden="true"></i>sports event</li>
                        </ul>
                    </div>
                    <div class="readmore">
                        <a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>   
...
<!-- Mirrored from wp1.themexlab.com/html/smart-up/single-event.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Sep 2017 13:04:12 GMT -->
</html>