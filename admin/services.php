              ...
              <div class="row" style="margin-right: 0px; margin-left: 0px;">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="col-md-10">
                          ...
                          <div class="col-md-2">
                              ...
                              <a href="servicesadd.php"><button type="button" class="btn btn-sm btn-success" style="display:block; width:100%">Add</button></a> 
                           </div>
                      </div>
                    </div>
                ...
                <!--               <td class="p-name" style="text-align:center;">< ?php echo $row['date1']; ?></td>
                          ...
                          <!--     <td class="p-name" style="text-align:center;">< ?php echo $row['place']; ?></td> -->
                              <td class="p-name" style="text-align:left;"><?php echo substr($row['service_content'],0,100); ?></td>
