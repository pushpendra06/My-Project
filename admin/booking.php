...
$sql1 = "SELECT * from booking LIMIT $start, $limit";
              ...
              <div class="row" style="margin-right: 0px; margin-left: 0px;">
                 <aside class="profile-nav col-lg-12">   
                   <section class="panel" style="margin:0px auto; overflow:auto;">
                    <div class="panel-body">
                      ...
                      <div class="col-md-12">
                          ...
                          <!-- <div class="col-md-2">
                              ...
                              <a href="booking_add.php"><button type="button" class="btn btn-sm btn-success" style="display:block; width:100%">Add</button></a> 
                           </div> -->
                        ...
                        <table class="table table-bordered" id="hide">
                            ...
                            <tbody>
                             ...
                             while($row=mysqli_fetch_array($run))
                              ...
                              <td class="p-name" style="text-align:center;"><?php echo $row['date2']; ?></td>
                              <td class="p-name" style="text-align:center;"><?php echo $row['cat']; ?></td>
                              <td class="p-name" style="text-align:center;"><?php echo $row['name']; ?></td>
                              <td class="p-name" style="text-align:center;"><?php echo $row['email']; ?></td>
                              <td class="p-name" style="text-align:center;"><?php echo $row['mob']; ?></td>
                              <td class="p-name" style="text-align:center;"><?php echo $row['address']; ?></td>
                              <td class="p-name" style="text-align:center;"><?php echo $row['city']; ?></td>
                              <td class="p-name" style="text-align:center;"><?php echo $row['btime']; ?></td> 
                              ...
                              {
                              ?>
                              <a href="bookingactive.php?rid=<?php echo $row['id']; ?>" class="btn btn-sm btn-success" onclick="return confirm('Activate')"><i class=" fa fa-eye"></i></a>
                              <?php
                              }
                              if(($status)=='1')
                              {
                              ?>
                              <a href="bookingactive.php?rid=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('De-activate')"><i class="fa fa-eye" aria-hidden="true"></i></a>
                              <?php
                              }
                              ?>
                              </td>
                              ...
                              <!--td class="p-progress" style="text-align:center;">  
                              <a href="bookingrep.php?rep=<?php echo $row['id']; ?>"><button type="button" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></button></a>
                              </td-->
                              <td class="p-progress" style="text-align:center;"> 
                              <a href="bookingdel.php?del=<?php echo $row['id']; ?>"><button type="button" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure Delete this client')"><i class="fa fa-trash-o "></i></button></a></td>
                              </td>
                    ...
                    <?php if($id>1) { ?>
                    <a href="booking.php?id=<?php echo ($id-1) ; ?>" class="btn btn-sm btn-success" >Privious</a>
                    <?php }

                    for ($i=1; $i<=$page; $i++)
                    { ?>
                    <a href="booking.php?id=<?php echo $i; ?>" class="btn btn-sm btn-success" ><?php echo $i; ?></a>

                    <?php } ?>
                    <?php if($id!=$page) { ?>
                    <a href="booking.php?id=<?php echo ($id+1); ?>" class="btn btn-sm btn-success" >Next</a>
                    <?php } ?>
                    </div>
                    </div>  
      </div><br><br> <br><br> 
...
slideractive("booking", $_POST['name']);
}
}
