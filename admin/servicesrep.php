...
$rep = $_GET['rep'];
$sql = "SELECT * from services_details where service_id = '$rep' ";
                  ...
                  <header class="panel-heading">
                    ...
                    <form method="post" enctype="multipart/form-data">       
                     ...
                     <!--  <div class="row" style="margin:10px 0px 0px 0px;">
                      ...
                      <div class="col-md-8">
                      <input placeholder="Enter events Name" name="events_name" value="<?php echo $row['service_name']; ?>" class="form-control" type="text" style="padding:0px 10px;">
                      </div>
                      <div class="col-md-1"></div>
                      </div>
                    ...
                    <div class="row" style="margin:10px 0px 0px 0px;">
                    <div class="col-md-1"></div>
                    <div class="col-md-1" style="padding:10px 0px;">Image</div>
                    <div class="col-md-1"><img src="<?php echo $row['service_img']; ?>" width="70px" height="70px"></div>
...
servicerep("services_details",  $_POST['events_name'],  $_POST['msg'], $_FILES['file_img'], $rep, $file1);
}
