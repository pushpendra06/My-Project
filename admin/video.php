...
$sql1 = "SELECT * from video LIMIT $start, $limit";
                    ...
                    <div class="panel-body">
                      ...
                      <div class="col-md-10">
                          ...
                          <div class="col-md-2">
                              ...
                              <a href="videoadd.php"><button type="button" class="btn btn-sm btn-success" style="display:block; width:100%">Add</button></a> 
                           </div>
                      </div>
                    </div>
                        ...
                        <table class="table table-bordered" id="hide">
                            ...
                            <tbody>
                             ...
                             while($row=mysqli_fetch_array($run))
                              ...
                              <td class="p-name" style="text-align:center;"><?php echo $row['url']; ?></td>
                              <td class="p-progress" style="text-align:center;">  
                              <?php
                              if(($status)=='0')
                              {
                              ?>
                              <a href="videoactive.php?rid=<?php echo $row['id']; ?>" class="btn btn-sm btn-success" onclick="return confirm('Activate')"><i class=" fa fa-eye"></i></a>
                              <?php
                              }
                              if(($status)=='1')
                              {
                              ?>
                              <a href="videoactive.php?rid=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('De-activate')"><i class="fa fa-eye" aria-hidden="true"></i></a>
                              <?php
                              }
                              ?>
                              </td>
                              ...
                              <td class="p-progress" style="text-align:center;">  
                              <a href="videorep.php?rep=<?php echo $row['id']; ?>"><button type="button" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></button></a>
                              </td>
                              <td class="p-progress" style="text-align:center;"> 
                              <a href="videodel.php?del=<?php echo $row['id']; ?>"><button type="button" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure Delete this client')"><i class="fa fa-trash-o "></i></button></a></td>
                              </td>
...
<?php if($id>1) { ?>
<a href="video.php?id=<?php echo ($id-1) ; ?>" class="btn btn-sm btn-success" >Privious</a>
<?php }

for ($i=1; $i<=$page; $i++)
{ ?>
<a href="video.php?id=<?php echo $i; ?>" class="btn btn-sm btn-success" ><?php echo $i; ?></a>

<?php } ?>
<?php if($id!=$page) { ?>
<a href="video.php?id=<?php echo ($id+1); ?>" class="btn btn-sm btn-success" >Next</a>
<?php } ?>
</div>
</div>  
      </div><br><br> <br><br> 
...
function getStates(value){
  $.post("videosearch.php",{partialState:value}, function(data){
    $("#demo").html(data);
  });
